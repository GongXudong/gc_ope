...
uv run --offline scripts/evaluate_ckpt/evaluate_flycraft.py algo_type=ppo ckpt_dir=checkpoints/flycraft/easy/ppo/seed_1 env=flycraft_for_ppo process_num=64 eval_cfg.dg_gen_method=random eval_cfg.eval_dg_num=1000 eval_res_csv_file_suffix=eval_res_on_random seed=23
uv run --offline scripts/evaluate_ckpt/evaluate_flycraft.py algo_type=ppo ckpt_dir=checkpoints/flycraft/easy/ppo/seed_2 env=flycraft_for_ppo process_num=64 eval_cfg.dg_gen_method=random eval_cfg.eval_dg_num=1000 eval_res_csv_file_suffix=eval_res_on_random seed=31
uv run --offline scripts/evaluate_ckpt/evaluate_flycraft.py algo_type=ppo ckpt_dir=checkpoints/flycraft/easy/ppo/seed_3 env=flycraft_for_ppo process_num=64 eval_cfg.dg_gen_method=random eval_cfg.eval_dg_num=1000 eval_res_csv_file_suffix=eval_res_on_random seed=45
uv run --offline scripts/evaluate_ckpt/evaluate_flycraft.py algo_type=ppo ckpt_dir=checkpoints/flycraft/easy/ppo/seed_4 env=flycraft_for_ppo process_num=64 eval_cfg.dg_gen_method=random eval_cfg.eval_dg_num=1000 eval_res_csv_file_suffix=eval_res_on_random seed=51
